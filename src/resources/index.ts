  ...
  switch (uri) {
    case "notion://server/guide":
      return [
        ...
        "## Reading",
        "",
        "- Use `notion_retrieve_page` for page metadata.",
        "- Use `notion_retrieve_block_children` for page or block content.",
    ...
    case "notion://server/tools":
      return [
        ...
        "## Low-level API tools",
        "",
        "- Blocks: `notion_append_block_children`, `notion_retrieve_block`, `notion_retrieve_block_children`, `notion_update_block`, `notion_delete_block`.",
        "- Pages: `notion_retrieve_page`, `notion_update_page_properties`.",
        "- Data sources: `notion_create_data_source`, `notion_query_data_source`, `notion_retrieve_data_source`, `notion_update_data_source`, `notion_create_data_source_item`.",
