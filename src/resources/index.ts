  ...
  switch (uri) {
    case "notion://server/guide":
      return [
        ...
        "- Use `notion_plan_page_edit` to validate proposed multi-block edits before writing.",
        ...
        "- Use `notion_update_content_batch` when multiple existing simple blocks should be updated together.",
        "- For multi-block edits, plan with `notion_plan_page_edit` first, then execute the returned tool calls.",
    ...
    case "notion://server/tools":
      return [
        ...
        "- `notion_plan_page_edit`: dry-run validation and executable tool plan for page edits.",
        ...
        "- `notion_update_content_batch`: validated multi-block content update.",
        "- `notion_create_data_source_item_from_values`: simple values to Notion property JSON.",
        "",
        "## Low-level API tools",
        "",
        "- Blocks: `notion_append_block_children`, `notion_append_content`, `notion_update_content`, `notion_update_content_batch`, `notion_retrieve_block`, `notion_retrieve_block_children`, `notion_update_block`, `notion_delete_block`.",
        "- Pages: `notion_retrieve_page`, `notion_read_page`, `notion_plan_page_edit`, `notion_update_page_properties`.",
