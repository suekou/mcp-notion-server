        ...
        items: {
          ...
          properties: {
                ...
                date: {
                  ...
                  properties: {
                    start: {
                      type: "string",
                      description:
                        "An ISO 8601 formatted start date or date-time.",
                    },
                    end: {
                      type: ["string", "null"],
                      description:
                ...
                template_mention: {
                  ...
                  properties: {
                    ...
                    template_mention_date: {
                      ...
                      enum: ["today", "now"],
                      description:
                        "For template_mention_date type, the date keyword.",
                    },
                    template_mention_user: {
                      type: "string",
                      enum: ["me"],
                      description:
                        "For template_mention_user type, the user keyword.",
                    },
                  },
                },
                user: {
                  type: "object",
                  description:
                    "User mention object, contains a user reference.",
                  properties: {
                    object: {
                      type: "string",
            ...
            href: {
              type: "string",
              description:
                "The URL of any link or mention in this text, if any.",
            },
            plain_text: {
              type: "string",
